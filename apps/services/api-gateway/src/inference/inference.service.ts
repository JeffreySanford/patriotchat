...
export class InferenceService {
  ...
  constructor(@Inject(HttpService) private readonly httpService: HttpService) {
    console.log('[InferenceService] Constructor - HttpService available:', !!httpService);
  }

  getModels(): Observable<string[]> {
    console.log(`Fetching models from: ${this.llmServiceUrl}/inference/models`);
    return this.httpService.get<LLMModelsResponse>(
      `${this.llmServiceUrl}/inference/models`,
      { timeout: 5000 },
    ).pipe(
  ...
  generateInference(
    ...
    console.log(`Generating inference with model ${model} at ${this.llmServiceUrl}/inference/generate`);
    return this.httpService.post<LLMGenerateResponse>(
      ...
      map((response: AxiosResponse<LLMGenerateResponse>): InferenceGenerateResponse => ({
