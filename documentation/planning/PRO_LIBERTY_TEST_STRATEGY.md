...
- **Weekly Values Retrospective** – review automated results with human oversight, mark issues in `documentation/planning/PRO_LIBERTY_TRACKING.md`, and retarget sprints (PRO-LLM-001) if drift appears.
...
- Publish a short “Alignment Digest” after each sprint that summarizes pass/fail rates for these tests, highlights any drift, and lists remediation actions (e.g., re-weight data source, add new safeguards). Store digest in `documentation/planning/PRO_LIBERTY_TRACKING.md` archive section.
...
- Values Commitment / roadmap: `README.md#values-commitment` & `documentation/planning/PRO_LIBERTY_BUILD_GUIDE.md`
- Tracking board: `documentation/planning/PRO_LIBERTY_TRACKING.md`
